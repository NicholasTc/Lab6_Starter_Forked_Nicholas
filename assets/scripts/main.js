...
function initFormHandler() {
	...
	form.addEventListener('submit', (event) => {
		...
		// B5. TODO - Create an empty object (we'll refer to this object as recipeObject ...)
		const recipeObject = {};
		for (const [key, value] of formData.entries()) {
		recipeObject[key] = value;
		}

		// Convert rating and numRatings to numbers (they come in as strings)
		...
		// B9. TODO - Get the recipes array from localStorage, add this new recipe to it, and save back
